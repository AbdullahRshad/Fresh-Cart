...
const navigate=useNavigate()
  ...
  const validationSchema = Yup.object({
    ...
    rePassword: Yup.string()
      ...
      .oneOf([Yup.ref("password")], "RePassword and password must be matched"),
    phone: Yup.string()
...
<div className="min-h-screen flex items-center justify-center ">
      <div className="w-full md:w-1/2 lg:w-1/3 mx-auto  bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md shadow-sm disabled:bg-gray-400 " disabled={isLoading} >
